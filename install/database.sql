...
INSERT INTO `blog_comments` (`id`, `blog_id`, `user_id`, `parent_id`, `commented_by`, `comment_content`, `created_at`, `updated_at`) VALUES
(1, 6, 4, NULL, 'user', 'Hi', '2023-03-05 12:21:54', '2023-03-05 12:21:54'),
(2, 6, 4, NULL, 'user', 'How are you..?', '2023-03-05 12:22:02', '2023-03-05 12:22:02'),
(3, 6, 4, NULL, 'user', 'ok', '2023-03-23 23:08:08', '2023-03-23 23:08:08'),
(4, 4, 4, NULL, 'user', 'alert(1)', '2023-07-16 21:09:32', '2023-07-16 21:09:32'),
(5, 4, 4, NULL, 'user', '%3Cscript%3Ealert%281%29%3C%2Fscript%3E', '2023-07-16 21:09:46', '2023-07-16 21:09:46'),
(6, 1, 4, NULL, 'user', 'Test', '2023-08-10 08:56:17', '2023-08-10 08:56:17');
...
CREATE TABLE `booking_informations` (
  ...
  `payment_meta` varchar(191) DEFAULT NULL,
...
--
-- Table structure for table `domain_payment_logs`
--

CREATE TABLE `domain_payment_logs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  ...
  `user_details` longtext DEFAULT NULL COMMENT 'It will contain all data of the user converted into json',
  `ip_address` varchar(45) NOT NULL COMMENT 'User ip address',
  `domain` varchar(191) NOT NULL,
  `domain_price` double NOT NULL,
  `extra_fee` double NOT NULL DEFAULT 0,
  `period` int(11) NOT NULL DEFAULT 1,
  `privacy` tinyint(1) NOT NULL DEFAULT 0,
  `payment_gateway` varchar(191) DEFAULT NULL,
  `payment_status` tinyint(1) NOT NULL DEFAULT 0,
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'false means drafted and true means active',
  `custom_field` longtext DEFAULT NULL,
  `track` varchar(191) DEFAULT NULL,
  `contact_billing` longtext DEFAULT NULL,
  `contact_registrant` longtext DEFAULT NULL,
  `contact_tech` longtext DEFAULT NULL,
...
CREATE TABLE `hotels` (
  ...
  `restaurant_inside` varchar(191) DEFAULT NULL,
...
--
-- Table structure for table `hotel_benifits`
--

CREATE TABLE `hotel_benifits` (
  `id` int(10) UNSIGNED NOT NULL,
  `icon` varchar(191) NOT NULL,
...
--
-- Table structure for table `hotel_booking_payment_logs`
--

CREATE TABLE `hotel_booking_payment_logs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `booking_information_id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `reservation_id` varchar(191) DEFAULT NULL,
...
CREATE TABLE `hotel_reviews` (
  ...
  `room_id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `ratting` double(8,2) NOT NULL,
  `cleanliness` double(8,2) NOT NULL,
  `comfort` double(8,2) NOT NULL,
  `staff` double(8,2) NOT NULL,
  `facilities` double(8,2) NOT NULL,
...
CREATE TABLE `inventories` (
  ...
  `booked_room` int(11) DEFAULT NULL,
  `total_room` int(11) DEFAULT NULL,
  `extra_base_charge` decimal(8,2) DEFAULT NULL,
  `extra_adult` decimal(8,2) DEFAULT NULL,
  `extra_child` decimal(8,2) DEFAULT NULL,
  `min_night` int(11) DEFAULT NULL,
  `bookable` varchar(191) DEFAULT NULL,
  `refundable` varchar(191) DEFAULT NULL,
  `status` int(11) NOT NULL COMMENT '0 = not bookable and 1 = bookable',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(6, 'گؤنئی آذربایجان', 'azb', 0, 1, 0, '2024-02-13 23:37:28', '2024-02-13 23:37:28');
...
(215, 'peakpx (4).jpg', 'peakpx-41701057885.jpg', NULL, '71.67 KB', 0, 10, '1920 x 1080 pixels', '2023-11-27 04:04:45', '2023-11-27 04:04:45'),
(216, 'logo-195-123-removebg-preview.png', 'logo-195-123-removebg-preview1702056789.png', NULL, '17.98 KB', 0, 10, '195 x 123 pixels', '2023-12-08 17:33:09', '2023-12-08 17:33:09'),
(217, 'logo-600-117-removebg-preview.png', 'logo-600-117-removebg-preview1702056812.png', NULL, '120.85 KB', 0, 10, '600 x 380 pixels', '2023-12-08 17:33:32', '2023-12-08 17:33:32'),
(218, 'c.php56', 'c1705251605.jpg', NULL, '114.79 KB', 0, 10, '720 x 1118 pixels', '2024-01-14 11:00:05', '2024-01-14 11:00:05'),
(219, 'Group 6994.png', 'group-69941706719002.png', NULL, '276.75 KB', 0, 10, '987 x 771 pixels', '2024-01-31 10:36:43', '2024-01-31 10:36:43'),
(220, 'res.webp', 'res1707636594.webp', NULL, '325.38 KB', 0, 10, '1100 x 733 pixels', '2024-02-11 01:29:54', '2024-02-11 01:29:54'),
(221, 'res.webp', 'res1707636642.webp', NULL, '325.38 KB', 0, 10, '1100 x 733 pixels', '2024-02-11 01:30:43', '2024-02-11 01:30:43'),
(222, 'Restaurants.jpg', 'restaurants1707645558.jpg', NULL, '153.39 KB', 0, 10, '416 x 312 pixels', '2024-02-11 03:59:18', '2024-02-11 03:59:18');
...
(173, '2022_05_22_073403_create_hotel_images_table', 55),
(174, '2023_08_16_120421_create_amenities_table', 55),
(175, '2023_08_16_120422_create_hotels_table', 55),
(176, '2023_08_16_120424_create_room_type_amenities_table', 55),
(177, '2023_08_16_120425_create_hotel_amenities_table', 55),
(178, '2023_08_16_120428_create_bed_types_table', 55),
(179, '2023_08_16_120429_create_hotel_room_types_table', 55),
(180, '2023_08_16_120430_create_questions_table', 55),
(181, '2023_08_16_120432_create_hotel_benifits_table', 55),
(182, '2023_08_16_120433_create_room_types_table', 55),
(183, '2023_08_16_120434_create_rooms_table', 55),
(184, '2023_08_16_120435_create_address_table', 55),
(185, '2023_08_16_120435_create_bookings_table', 55),
(186, '2023_08_16_120435_create_room_images_table', 55),
(187, '2023_08_17_120434_create_inventories_table', 55),
(188, '2023_08_18_120435_create_room_inventories', 55),
(189, '2023_09_17_070622_create_room_type_inventories_table', 55),
(190, '2023_09_23_081151_create_cities_table', 55),
(191, '2023_10_03_082441_create_hotel_reviews_table', 55),
(192, '2023_10_16_101731_create_hotel_booking_payment_logs_table', 55),
(193, '2024_01_21_212237_create_domain_payment_logs_table', 56);
...
(14, 'PricePlan', 'update', 'dynamic_page', 1, 7, 'dynamic_page', '{\"id\":\"14\",\"addon_name\":\"PricePlan\",\"addon_namespace\":\"UGx1Z2luc1xQYWdlQnVpbGRlclxBZGRvbnNcTGFuZGxvcmRcQ29tbW9uXFByaWNlUGxhbg==\",\"addon_type\":\"update\",\"addon_location\":\"dynamic_page\",\"addon_order\":\"1\",\"addon_page_id\":\"7\",\"addon_page_type\":\"dynamic_page\",\"title_en_GB\":\"Our Pricing {h}Plan{\\/h}\",\"button_text_en_GB\":\"Buy Now\",\"trial_text_en_GB\":\"Try Now\",\"title_ar\":\"\\u062e\\u0637\\u0629 \\u0627\\u0644\\u0623\\u0633\\u0639\\u0627\\u0631 \\u0644\\u062f\\u064a\\u0646\\u0627\",\"button_text_ar\":\"\\u0627\\u0634\\u062a\\u0631\\u064a \\u0627\\u0644\\u0622\\u0646\",\"trial_text_ar\":\"\\u062c\\u0631\\u0628 \\u0627\\u0644\\u0622\\u0646\",\"title_tr_TR\":null,\"button_text_tr_TR\":null,\"trial_text_tr_TR\":null,\"order_by\":\"price\",\"order\":\"asc\",\"item_show\":null,\"plan_type_status\":\"on\",\"padding_top\":\"0\",\"padding_bottom\":\"0\"}', 'Plugins\\PageBuilder\\Addons\\Landlord\\Common\\PricePlan', '2022-08-03 06:58:16', '2023-12-01 03:41:13'),
...
(41, 'bank_transfer', '203', '', 1, 1, '{\"name\":\"Manual Payment\",\"description\":\"desc\"}', '2023-05-31 05:03:47', '2023-11-28 10:50:16'),
(42, 'kinetic', '88', '', 1, 1, '{\"name\":\"Kinetic Payment \",\"description\":\"desc\"}', '2023-08-10 14:04:10', '2023-08-10 14:04:10'),
(43, 'bank_transfer', '88', '', 1, 1, '{\"name\":\"Manual Payment \",\"description\":\"desc\"}', '2023-11-28 10:59:39', '2023-12-12 05:26:09'),
(44, 'bank_transfer', '88', '', 1, 1, '{\"name\":\"Manual Payment \",\"description\":\"desc\"}', '2023-12-11 23:31:15', '2023-12-11 23:40:07'),
(45, 'bank_transfer', '88', '', 1, 1, '{\"name\":\"Manual Payment \",\"description\":\"desc\"}', '2023-12-11 23:40:37', '2023-12-11 23:42:46'),
(46, 'bank_transfer', '88', '', 1, 1, '{\"name\":\"Manual Payment \",\"description\":\"desc\"}', '2023-12-11 23:57:43', '2024-02-11 03:52:34'),
(47, 'manual_payment_', '88', '', 1, 1, '{\"name\":\"Manual Payment \",\"description\":\"desc\"}', '2024-02-13 07:27:02', '2024-02-13 07:27:02');
...
(2395, 10, 'dashboard', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2396, 10, 'admin', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2397, 10, 'user', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2398, 10, 'brand', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2399, 10, 'newsletter', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2400, 10, 'custom_domain', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2401, 10, 'testimonial', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2402, 10, 'form_builder', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2403, 10, 'own_order_manage', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2404, 10, 'page', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2405, 10, 'blog', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2406, 10, 'service', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2407, 10, 'donation', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2408, 10, 'job', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2409, 10, 'appointment', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2410, 10, 'event', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2411, 10, 'support_ticket', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2412, 10, 'knowledgebase', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2413, 10, 'faq', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2414, 10, 'gallery', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2415, 10, 'video', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2416, 10, 'portfolio', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2417, 10, 'eCommerce', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2418, 10, 'storage', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2419, 10, 'advertisement', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2420, 10, 'wedding_price_plan', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2421, 10, 'appearance_settings', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2422, 10, 'general_settings', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2423, 10, 'language', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2424, 10, 'payment_gateways', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2425, 10, 'themes', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2426, 10, 'restaurant', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2427, 10, 'paypal', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2428, 10, 'paytm', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2429, 10, 'stripe', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2430, 10, 'razorpay', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2431, 10, 'paystack', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2432, 10, 'mollie', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2433, 10, 'midtrans', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2434, 10, 'cashfree', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2435, 10, 'instamojo', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2436, 10, 'marcadopago', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2437, 10, 'zitopay', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2438, 10, 'squareup', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2439, 10, 'cinetpay', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2440, 10, 'paytabs', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2441, 10, 'billplz', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2442, 10, 'flutterwave', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2443, 10, 'payfast', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2444, 10, 'toyyibpay', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2445, 10, 'pagali', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2446, 10, 'authorizenet', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2447, 10, 'sitesway', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2448, 10, 'bank_transfer', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2449, 10, 'bank_transfer', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2450, 10, 'kinetic', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2451, 10, 'bank_transfer', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2452, 10, 'bank_transfer', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2453, 10, 'bank_transfer', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2454, 10, 'theme-agency', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2455, 10, 'theme-article-listing', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2456, 10, 'theme-barber-shop', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2457, 10, 'theme-construction', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2458, 10, 'theme-consultancy', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2459, 10, 'theme-donation', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2460, 10, 'theme-eCommerce', 0, '2024-02-11 01:31:34', '2024-02-11 01:31:34'),
(2461, 10, 'theme-event', 0, '2024-02-11 01:31:35', '2024-02-11 01:31:35'),
(2462, 10, 'theme-hotel-booking', 0, '2024-02-11 01:31:35', '2024-02-11 01:31:35'),
(2463, 10, 'theme-job-find', 0, '2024-02-11 01:31:35', '2024-02-11 01:31:35'),
(2464, 10, 'theme-newspaper', 0, '2024-02-11 01:31:35', '2024-02-11 01:31:35'),
(2465, 10, 'theme-photography', 0, '2024-02-11 01:31:35', '2024-02-11 01:31:35'),
(2466, 10, 'theme-portfolio', 0, '2024-02-11 01:31:35', '2024-02-11 01:31:35'),
(2467, 10, 'theme-restaurant', 0, '2024-02-11 01:31:35', '2024-02-11 01:31:35'),
(2468, 10, 'theme-software-business', 0, '2024-02-11 01:31:35', '2024-02-11 01:31:35'),
(2469, 10, 'theme-support-ticketing', 0, '2024-02-11 01:31:35', '2024-02-11 01:31:35'),
(2470, 10, 'theme-wedding', 0, '2024-02-11 01:31:35', '2024-02-11 01:31:35'),
(2471, 1, 'dashboard', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2472, 1, 'admin', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2473, 1, 'user', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2474, 1, 'brand', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2475, 1, 'custom_domain', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2476, 1, 'testimonial', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2477, 1, 'form_builder', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2478, 1, 'own_order_manage', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2479, 1, 'page', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2480, 1, 'blog', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2481, 1, 'service', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2482, 1, 'donation', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2483, 1, 'job', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2484, 1, 'event', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2485, 1, 'support_ticket', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2486, 1, 'knowledgebase', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2487, 1, 'faq', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2488, 1, 'gallery', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2489, 1, 'video', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2490, 1, 'portfolio', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2491, 1, 'storage', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2492, 1, 'appearance_settings', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2493, 1, 'general_settings', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2494, 1, 'language', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2495, 1, 'payment_gateways', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2496, 1, 'themes', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2497, 1, 'domainreseller', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2498, 1, 'paytm', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2499, 1, 'stripe', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2500, 1, 'mollie', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2501, 1, 'midtrans', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2502, 1, 'cashfree', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2503, 1, 'theme-eCommerce', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34'),
(2504, 1, 'theme-portfolio', 0, '2024-02-14 00:57:34', '2024-02-14 00:57:34');
...
(1, '{\"en_GB\":\"Basic Monthly\",\"ar\":\"\\u0645\\u062f\\u0649 \\u0627\\u0644\\u062d\\u064a\\u0627\\u0629 \\u0627\\u0644\\u0623\\u0633\\u0627\\u0633\\u064a\"}', '{\"en_GB\":\"You can easily create your website by Pica. We will provide all type of digital service for you.\",\"ar\":\"\\u064a\\u0645\\u0643\\u0646\\u0643 \\u0628\\u0633\\u0647\\u0648\\u0644\\u0629 \\u0625\\u0646\\u0634\\u0627\\u0621 \\u0645\\u0648\\u0642\\u0639 \\u0627\\u0644\\u0648\\u064a\\u0628 \\u0627\\u0644\\u062e\\u0627\\u0635 \\u0628\\u0643 \\u0639\\u0646 \\u0637\\u0631\\u064a\\u0642 Pica. \\u0633\\u0648\\u0641 \\u0646\\u0642\\u062f\\u0645 \\u0644\\u0643 \\u062c\\u0645\\u064a\\u0639 \\u0623\\u0646\\u0648\\u0627\\u0639 \\u0627\\u0644\\u062e\\u062f\\u0645\\u0627\\u062a \\u0627\\u0644\\u0631\\u0642\\u0645\\u064a\\u0629.\"}', 0, 1, 50, NULL, 'a:2:{s:5:\"title\";a:3:{i:0;s:9:\"Good Plan\";i:1;s:10:\"Basic Plan\";i:2;s:11:\"Simple Plan\";}s:11:\"description\";a:3:{i:0;s:179:\"In a free hour, when our power of choice is untrammelled and when nothing prevents our being able to do what we like best, every pleasure is to be welcomed and every pain avoided.\";i:1;s:179:\"In a free hour, when our power of choice is untrammelled and when nothing prevents our being able to do what we like best, every pleasure is to be welcomed and every pain avoided.\";i:2;s:179:\"In a free hour, when our power of choice is untrammelled and when nothing prevents our being able to do what we like best, every pleasure is to be welcomed and every pain avoided.\";}}', 20, 16, 20, 1, 10, '2022-07-06 10:16:18', '2024-02-14 00:57:34', 10, 20, 30, 14, 28, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 200, NULL),
...
(10, '{\"en_GB\":\"Super duper premium\"}', '{\"en_GB\":\"Super duper premium\"}', 2, 1, 1000, NULL, 'a:2:{s:5:\"title\";a:1:{i:0;s:3:\"sdf\";}s:11:\"description\";a:1:{i:0;s:3:\"sdf\";}}', NULL, NULL, NULL, 1, 10, '2023-11-09 08:39:33', '2024-02-11 01:31:34', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 500, NULL);
...
--
-- Table structure for table `room_inventories`
--
...
CREATE TABLE `room_inventories` (
  ...
  `status` int(11) NOT NULL COMMENT 'now it will be empty in future we will make it better'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `room_types` (
  ...
  `max_guest` int(11) DEFAULT 0,
  `max_adult` int(11) DEFAULT 0,
  `max_child` int(11) DEFAULT 0,
  `no_bedroom` int(11) DEFAULT 0,
  `no_living_room` int(11) DEFAULT 0,
  `no_bathrooms` int(11) DEFAULT 0,
  `base_charge` decimal(8,2) DEFAULT NULL,
  `extra_adult` int(11) DEFAULT NULL,
  `extra_child` int(11) DEFAULT NULL,
  `breakfast_price` decimal(8,2) DEFAULT NULL,
  `lunch_price` decimal(8,2) DEFAULT NULL,
  `dinner_price` decimal(8,2) DEFAULT NULL,
  `bed_type_id` bigint(20) UNSIGNED DEFAULT NULL,
  `extra_bed_type_id` bigint(20) UNSIGNED DEFAULT NULL,
  `hotel_id` bigint(20) UNSIGNED NOT NULL,
  `description` text DEFAULT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 1,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Table structure for table `room_type_inventories`
--
...
CREATE TABLE `room_type_inventories` (
  ...
  `booked_quantity` int(11) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT 1,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(14, 'get_script_version', '2.2.3', '2022-02-02 01:29:18', '2022-12-09 10:33:24'),
...
(28, 'site_global_email', '', '2022-02-07 01:31:24', '2022-11-15 06:52:16'),
...
(108, 'timezone', 'Africa/Abidjan', '2022-05-30 05:36:32', '2023-12-12 05:28:30'),
...
(246, 'set_app_name_env', 'Multipurposesaas Test', '2023-11-28 10:46:39', '2023-11-28 10:47:20'),
(247, 'set_app_debug_env', 'on', '2023-11-28 10:46:39', '2023-12-12 05:28:30'),
(248, 'site_tr_TR_title', NULL, '2023-11-28 10:48:20', '2023-11-28 10:48:20'),
(249, 'site_tr_TR_tag_line', NULL, '2023-11-28 10:48:20', '2023-11-28 10:48:20'),
(250, 'site_tr_TR_footer_copyright_text', NULL, '2023-11-28 10:48:20', '2023-11-28 10:48:20');
...
(5, 'get_script_version', '2.2.4', 'f22f95ff-8354-40c7-9aa3-3435f7c58be0', '2022-12-23 16:37:46', '2023-08-10 14:10:09'),
...
(13, 'all_central_langs', '{\"en_GB\":\"English (UK)\",\"ar\":\"\\u0627\\u0644\\u0639\\u0631\\u0628\\u064a\\u0629\",\"en_US\":\"English (USA)\",\"tr_TR\":\"T\\u00fcrk\\u00e7e\",\"azb\":\"\\u06af\\u0624\\u0646\\u0626\\u06cc \\u0622\\u0630\\u0631\\u0628\\u0627\\u06cc\\u062c\\u0627\\u0646\"}', 'f7db2ee2-0078-461e-bae8-3d1e1b251c40', '2023-03-06 01:39:23', '2024-02-13 23:37:28'),
...
(158, 'restaurant_theme_name_en_GB', 'Restaurant', '75718947-8433-4161-87a7-88d18c90a725', '2024-02-11 01:30:51', '2024-02-11 01:30:51'),
(159, 'restaurant_theme_description_en_GB', 'Restaurant Theme', 'c3200924-d1ca-4a79-915b-6dc14f7721d1', '2024-02-11 01:30:51', '2024-02-11 06:06:56'),
(160, 'restaurant_theme_name_ar', NULL, 'e046813e-68f5-41e6-a827-302db9f0f976', '2024-02-11 01:30:51', '2024-02-11 01:30:51'),
(161, 'restaurant_theme_description_ar', NULL, '01c19c51-6f08-4101-8bd5-31190942f5e0', '2024-02-11 01:30:51', '2024-02-11 01:30:51'),
(162, 'restaurant_theme_name_tr_TR', NULL, '90aae2a2-9233-4428-b6af-154cc074839e', '2024-02-11 01:30:51', '2024-02-11 01:30:51'),
(163, 'restaurant_theme_description_tr_TR', NULL, 'a75b3e7d-859b-4559-9e39-6d4a97672805', '2024-02-11 01:30:51', '2024-02-11 01:30:51'),
(164, 'restaurant_theme_url', 'https://restaurant.multipurposesass.com', '2bee25fe-2c84-443b-9492-d15df8600369', '2024-02-11 01:30:51', '2024-02-11 06:06:17'),
(165, 'restaurant_theme_image', 'https://multipurposesass.com/assets/landlord/uploads/media-uploader/restaurants1707645558.jpg', '70423452-c03c-4736-ac6f-643c9a299e62', '2024-02-11 01:30:51', '2024-02-11 03:59:45'),
(166, 'restaurant_theme_is_available', 'on', '01e775c3-2254-45db-b9bb-5c6020940980', '2024-02-11 01:30:51', '2024-02-11 01:30:51'),
(167, 'restaurant_theme_image_id', '222', 'eab4fb19-100b-41ff-85f5-fbbf8d8c7991', '2024-02-11 01:30:51', '2024-02-11 03:59:45');
...
(1, 4, 1250, 0, '2023-07-03 05:55:06', '2023-11-30 01:33:48', NULL),
(2, 6, 100, 0, '2023-07-12 19:26:15', '2023-07-12 19:26:37', NULL),
(3, 7, 0, 1, '2023-11-29 15:12:42', '2024-02-14 09:24:34', NULL);
...
(1, 4, 'stripe', 'complete', 100, 'pi_3NPfj5EmGOuJLTMs0EJWdswl', '0', 1, '2023-07-03 05:55:06', '2023-07-03 05:55:26'),
(2, 4, 'manual_payment_', '', 40, NULL, '0', 1, '2023-07-03 05:55:51', '2023-07-03 05:55:51'),
(3, 4, 'flutterwave', '', 200, NULL, '0', 1, '2023-07-07 23:57:51', '2023-07-07 23:57:51'),
(4, 4, 'manual_payment_', 'pending', 1000, NULL, '0', 1, '2023-07-08 16:53:12', '2023-07-08 16:53:12'),
(5, 4, 'marcadopago', '', 100, NULL, '0', 1, '2023-07-10 04:00:55', '2023-07-10 04:00:55'),
(6, 4, 'paytm', '', 44, NULL, '0', 1, '2023-07-12 00:43:26', '2023-07-12 00:43:26'),
(7, 4, 'manual_payment_', 'pending', 5000, NULL, '0', 1, '2023-07-12 16:33:23', '2023-07-12 16:33:23'),
(8, 4, 'flutterwave', '', 50, NULL, '0', 1, '2023-07-12 19:08:26', '2023-07-12 19:08:26'),
(9, 6, 'stripe', 'complete', 100, 'pi_3NT8g1EmGOuJLTMs1l2X6ekN', '0', 1, '2023-07-12 19:26:15', '2023-07-12 19:26:37'),
(10, 4, 'manual_payment_', 'pending', 4500, NULL, '0', 1, '2023-07-12 23:22:05', '2023-07-12 23:22:05'),
(11, 4, 'marcadopago', '', 100, NULL, '0', 1, '2023-07-12 23:43:30', '2023-07-12 23:43:30'),
(12, 4, 'stripe', '', 10, NULL, '0', 1, '2023-07-17 01:21:53', '2023-07-17 01:21:53'),
(13, 4, 'manual_payment_', 'pending', 230, NULL, '0', 1, '2023-07-17 19:27:53', '2023-07-17 19:27:53'),
(14, 4, 'midtrans', '', 100, NULL, '0', 1, '2023-07-18 17:19:06', '2023-07-18 17:19:06'),
(15, 4, 'razorpay', 'complete', 1000, 'pay_MKJm3zfCFkJNhU', '0', 1, '2023-07-31 06:58:47', '2023-07-31 06:59:17'),
(16, 4, 'stripe', '', 125, NULL, '0', 1, '2023-08-08 08:18:38', '2023-08-08 08:18:38'),
(17, 4, 'razorpay', 'complete', 100, 'pay_MOIyAnEIBHulbZ', '0', 1, '2023-08-10 08:46:22', '2023-08-10 08:48:04'),
(18, 4, 'cinetpay', '', 1000, NULL, '0', 1, '2023-08-10 12:01:31', '2023-08-10 12:01:31'),
(19, 4, 'manual_payment_', 'pending', 13, NULL, '0', 1, '2023-08-13 22:34:59', '2023-08-13 22:34:59'),
(20, 4, 'manual_payment_', 'pending', 13, NULL, '0', 1, '2023-08-13 22:35:06', '2023-08-13 22:35:06'),
(21, 4, 'manual_payment_', 'pending', 13, NULL, '0', 1, '2023-08-13 22:35:10', '2023-08-13 22:35:10'),
(22, 4, 'manual_payment_', 'pending', 13, NULL, '0', 1, '2023-08-13 22:35:11', '2023-08-13 22:35:11'),
(23, 4, 'manual_payment_', 'pending', 13, NULL, '0', 1, '2023-08-13 22:35:11', '2023-08-13 22:35:11'),
(24, 4, 'manual_payment_', 'pending', 13, NULL, '0', 1, '2023-08-13 22:35:28', '2023-08-13 22:35:28'),
(25, 4, 'manual_payment_', 'pending', 13, NULL, '0', 1, '2023-08-13 22:35:28', '2023-08-13 22:35:28'),
(26, 4, 'manual_payment_', 'pending', 16, NULL, '0', 1, '2023-08-13 22:36:45', '2023-08-13 22:36:45'),
(27, 4, 'stripe', '', 1000, NULL, '0', 1, '2023-08-17 20:02:40', '2023-08-17 20:02:40'),
(28, 4, 'stripe', '', 10, NULL, '0', 1, '2023-08-18 06:20:36', '2023-08-18 06:20:36'),
(29, 4, 'kinetic', '', 10, NULL, '0', 1, '2023-08-18 06:21:28', '2023-08-18 06:21:28'),
(30, 4, 'paypal', '', 200, NULL, '0', 1, '2023-08-21 12:09:36', '2023-08-21 12:09:36'),
(31, 4, 'stripe', '', 300, NULL, '0', 1, '2023-08-26 03:03:18', '2023-08-26 03:03:18'),
(32, 4, 'paypal', '', 10, NULL, '0', 1, '2023-08-28 16:43:19', '2023-08-28 16:43:19'),
(33, 4, 'paytm', '', 23, NULL, '0', 1, '2023-09-03 20:37:55', '2023-09-03 20:37:55'),
(34, 4, 'bank_transfer', '', 60, NULL, '0', 1, '2023-09-09 14:45:05', '2023-09-09 14:45:05'),
(35, 4, 'marcadopago', '', 60, NULL, '0', 1, '2023-09-09 14:45:29', '2023-09-09 14:45:29'),
(36, 4, 'midtrans', '', 5000, NULL, '0', 1, '2023-11-18 06:50:43', '2023-11-18 06:50:43'),
(37, 7, 'paypal', '', 888, NULL, '0', 1, '2023-11-29 15:12:42', '2023-11-29 15:12:42'),
(38, 4, 'midtrans', '', 50, NULL, '0', 1, '2023-11-30 01:28:32', '2023-11-30 01:28:32'),
(39, 4, 'midtrans', '', 50, NULL, '0', 1, '2023-11-30 01:29:25', '2023-11-30 01:29:25'),
(40, 4, 'midtrans', '', 50, NULL, '0', 1, '2023-11-30 01:30:03', '2023-11-30 01:30:03'),
(41, 4, 'midtrans', '', 50, NULL, '0', 1, '2023-11-30 01:32:03', '2023-11-30 01:32:03'),
(42, 4, 'midtrans', 'complete', 50, '6a4f968c-2685-42a5-bfa4-cf1ec2ca0cf0', '0', 1, '2023-11-30 01:32:46', '2023-11-30 01:33:48'),
(43, 4, 'paytm', '', 55, NULL, '0', 1, '2023-11-30 07:54:49', '2023-11-30 07:54:49'),
(44, 4, 'bank_transfer', '', 13, NULL, '0', 1, '2023-12-01 13:02:56', '2023-12-01 13:02:56'),
(45, 4, 'paytm', '', 250, NULL, '0', 1, '2023-12-02 02:44:42', '2023-12-02 02:44:42'),
(46, 7, 'kinetic', '', 10, NULL, '0', 1, '2023-12-11 09:16:21', '2023-12-11 09:16:21'),
(47, 4, 'paytm', '', 500, NULL, '0', 1, '2023-12-11 18:59:06', '2023-12-11 18:59:06'),
(48, 4, 'stripe', '', 500, NULL, '0', 1, '2024-01-03 20:50:36', '2024-01-03 20:50:36'),
(49, 4, 'stripe', '', 500, NULL, '0', 1, '2024-01-03 20:50:36', '2024-01-03 20:50:36'),
(50, 4, 'paypal', '', 1200, NULL, '0', 1, '2024-01-23 16:35:57', '2024-01-23 16:35:57'),
(51, 4, 'paypal', '', 1200, NULL, '0', 1, '2024-01-23 16:37:17', '2024-01-23 16:37:17'),
(52, 4, 'cinetpay', '', 200, NULL, '0', 1, '2024-01-28 05:08:52', '2024-01-28 05:08:52'),
(53, 4, 'paytm', '', 44, NULL, '0', 1, '2024-02-17 17:33:04', '2024-02-17 17:33:04');
...
(1, 4, 1, 0, NULL, '2023-07-17 12:06:48', '2024-01-25 13:42:23');
...
INSERT INTO `wallet_tenant_lists` (`id`, `user_id`, `tenant_id`, `created_at`, `updated_at`) VALUES
(5, 4, 'wedding', '2024-01-25 13:42:23', '2024-01-25 13:42:23');
...
--
-- Indexes for table `booking_informations`
--
ALTER TABLE `booking_informations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `booking_informations_room_type_id_foreign` (`room_type_id`),
  ADD KEY `booking_informations_hotel_id_foreign` (`hotel_id`),
  ADD KEY `booking_informations_country_id_foreign` (`country_id`);
...
--
-- Indexes for table `domain_payment_logs`
--
ALTER TABLE `domain_payment_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `domain_payment_logs_user_id_index` (`user_id`),
  ADD KEY `domain_payment_logs_tenant_id_index` (`tenant_id`),
  ADD KEY `domain_payment_logs_ip_address_index` (`ip_address`);
...
--
-- Indexes for table `hotel_benifits`
--
ALTER TABLE `hotel_benifits`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `hotel_booking_payment_logs`
--
ALTER TABLE `hotel_booking_payment_logs`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `hotel_reviews`
  ...
  ADD KEY `hotel_reviews_room_id_foreign` (`room_id`),
...
--
-- Indexes for table `room_inventories`
--
ALTER TABLE `room_inventories`
  ADD PRIMARY KEY (`id`),
  ADD KEY `room_inventories_inventory_id_foreign` (`inventory_id`),
  ADD KEY `room_inventories_room_type_id_foreign` (`room_type_id`),
  ADD KEY `room_inventories_room_id_foreign` (`room_id`);
...
ALTER TABLE `room_types`
  ...
  ADD KEY `room_types_extra_bed_type_id_foreign` (`extra_bed_type_id`);
...
--
-- Indexes for table `room_type_inventories`
--
ALTER TABLE `room_type_inventories`
  ADD PRIMARY KEY (`id`),
  ADD KEY `room_type_inventories_room_type_id_foreign` (`room_type_id`);
...
--
-- AUTO_INCREMENT for table `booking_informations`
--
ALTER TABLE `booking_informations`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `domain_payment_logs`
--
ALTER TABLE `domain_payment_logs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `hotel_benifits`
--
ALTER TABLE `hotel_benifits`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `hotel_booking_payment_logs`
--
ALTER TABLE `hotel_booking_payment_logs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `room_inventories`
--
ALTER TABLE `room_inventories`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `room_type_inventories`
--
ALTER TABLE `room_type_inventories`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `booking_informations`
--
ALTER TABLE `booking_informations`
  ADD CONSTRAINT `booking_informations_country_id_foreign` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `booking_informations_hotel_id_foreign` FOREIGN KEY (`hotel_id`) REFERENCES `hotels` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `booking_informations_room_type_id_foreign` FOREIGN KEY (`room_type_id`) REFERENCES `room_types` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `hotel_amenities`
  ADD CONSTRAINT `hotel_amenities_amenities_id_foreign` FOREIGN KEY (`amenities_id`) REFERENCES `amenities` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `hotel_reviews`
  ADD CONSTRAINT `hotel_reviews_hotel_id_foreign` FOREIGN KEY (`hotel_id`) REFERENCES `hotels` (`id`),
  ADD CONSTRAINT `hotel_reviews_room_id_foreign` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`id`),
  ADD CONSTRAINT `hotel_reviews_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
...
--
-- Constraints for table `room_inventories`
--
ALTER TABLE `room_inventories`
  ADD CONSTRAINT `room_inventories_inventory_id_foreign` FOREIGN KEY (`inventory_id`) REFERENCES `inventories` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `room_inventories_room_id_foreign` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `room_inventories_room_type_id_foreign` FOREIGN KEY (`room_type_id`) REFERENCES `room_types` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `room_types`
--
ALTER TABLE `room_types`
  ADD CONSTRAINT `room_types_bed_type_id_foreign` FOREIGN KEY (`bed_type_id`) REFERENCES `bed_types` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `room_types_extra_bed_type_id_foreign` FOREIGN KEY (`extra_bed_type_id`) REFERENCES `bed_types` (`id`) ON DELETE CASCADE,
...
--
-- Constraints for table `room_type_inventories`
--
ALTER TABLE `room_type_inventories`
  ADD CONSTRAINT `room_type_inventories_room_type_id_foreign` FOREIGN KEY (`room_type_id`) REFERENCES `room_types` (`id`) ON DELETE CASCADE;
COMMIT;
